# webgl-works-36 Caustics

<img src="./public/assets/images/screenshot.png" />

[https://taic-dev.github.io/webgl-works-36](https://taic-dev.github.io/webgl-works-36)
...
1. Clone the repository:
  ```bash
  git clone git@github.com:taic-dev/webgl-works-36.git
